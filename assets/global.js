...
// Grab all the FAQ items
const faqItems = document.querySelectorAll(".faq-wrap-item");
...
faqItems.forEach((item) => {
  const question = item.querySelector(".faq-button span").textContent;
  const answer = item.querySelector(".faq-wrap").innerHTML;

  // Push each FAQ as a question-answer pair into the mainEntity array
...
// Inject the FAQ schema into the head as JSON-LD
const script = document.createElement("script");
script.type = "application/ld+json";
script.textContent = JSON.stringify(faqSchema);
document.head.appendChild(script);

var elementToInsert = document.querySelector('.featured_jennie_love');
var targetElement = document.querySelector('.featured_jennie_slider .rte');

// Check if both elements exist
if (elementToInsert && targetElement) {
    ...
    console.log('Error: One or both of the elements were not found.');
}
